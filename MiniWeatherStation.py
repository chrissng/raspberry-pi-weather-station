...
# Oauth JSON File
GDOCS_OAUTH_JSON       = 'rpi-weather-station-dd908acd5712.json'

# Google Docs spreadsheet name.
GDOCS_SPREADSHEET_NAME = 'weather'
...
def get_calibrated_temp(sense_temp, cpu_temp):
    return sense_temp - ((cpu_temp - sense_temp)/5.466)
...
while True:
	...
	temp = round(get_calibrated_temp(temp, get_cpu_temp()), 1)
